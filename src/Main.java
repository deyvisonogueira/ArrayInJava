...
public class Main {
	...
	public static void main(String[] args) {
		...
		int choiceLimit;
		int selectNumber;
		choiceLimit = limitArray.nextInt();/*Salvando o tamanho do vetor de acordo com ob que o usúario digitar*/
		limiter = choiceLimit;
		...
		for(int i=0; i<= (choiceLimit - 1); i++) {/*Criação do vetor com - 1 para começar de 0*/
